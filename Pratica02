...
public class Pratica02 {
    public static void main(String[] args) {
        ...
        int troco, valorCompra, pagamento, nota50, nota20, nota10, nota5, nota2, nota1;
        ...
        System.out.print("Nota de 1: ");
        nota1 = teclado.nextInt();

        pagamento = (nota50 * 50) + (nota20 * 20) + (nota10 * 10) + (nota5 * 5) + (nota2 * 2) + (nota1 * 1);
